...
# inclusive. Unless it is the weekend, in which 
# case there is no upper bound on the number of 
# cigars. Return True if the party with the 
...
def cigar_party(cigars, is_weekend):
  if(is_weekend and cigars >= 40 or (is_weekend == False and (cigars >= 40 and cigars <= 60))):
    return True
  else:
    return False
