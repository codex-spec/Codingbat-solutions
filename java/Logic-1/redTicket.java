...
// the result is 5. Otherwise so long as both b and c
// are different from a, the result is 1. Otherwise the 
// result is 0.
...
public int redTicket(int a, int b, int c) {
  ...
  // else if(a == b && b == c && a != 2) return 5;
  // else if(b != a && c != a) return 1;
  // return 0;
  
  return (a == 2 && b == 2 && c ==2) ? 10 : (a == b && b == c && a != 2) ? 5 
  : (b != a && c != a) ? 1 : 0;
}
