...
// is the sum of the previous two values, so the 
// whole sequence is: 0, 1, 1, 2, 3, 5, 8, 13, 21 
// and so on. Define a recursive fibonacci(n) method 
// that returns the nth fibonacci number, with n=0 
